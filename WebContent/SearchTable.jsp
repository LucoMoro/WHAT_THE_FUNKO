...
<body>
		<%
		ArrayList<ProductBean> prodotti = (ArrayList<ProductBean>) request.getSession().getAttribute("ricerca");
		%>
    ...
    <div class="errorcontainer">
        <div class="errorpage">
            ...
            <h1>PRODOTTO NON PRESENTE NEL CATALOGO</h1>
            <p>Il prodotto cercato non è stato trovato, per vedere tutti i prodotti, clicca su "<i>SCOPRI DI PIÙ</i>" nella Home</p>
